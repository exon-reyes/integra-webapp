...
export const Autoridades={
    ...
    VACACIONES_GESTOR_FILTRO_RESPONSABLE: 'EB2',
    VACACIONES_GESTOR_DESCARGAR_PAPELETA: 'EB3',
    VACACIONES_AUTORIZACION_NIVEL1: 'EB4',
    VACACIONES_AUTORIZACION_NIVEL2: 'EB5',
    VACACIONES_GESTOR_FILTRO_SUPERVISOR: 'EB6',
    VACACIONES_GESTOR_VER_DETALLES_SOLICITUD: 'EB7',
    VACACIONES_GESTOR_NUEVO_REGISTRO: 'EB8',

    VACACIONES_SALDO_CONSULTAR: 'EC1',
    VACACIONES_SALDO_EXPORTAR_CATALOGO_VACACIONES: 'EC2',
    VACACIONES_SALDO_FILTRO_SUPERVISOR: 'EC3',
    VACACIONES_SALDO_FILTRO_RESPONSABLE: 'EC4',

    VACACIONES_CONFIGURACION_CONSULTAR: 'ED1'
