...
import {
    GuardarHorariosRequest,
    HorarioOperativoService,
} from '@/core/services/empresa/horario-operativo.service';
...
@Component({
    ...
    imports: [Button, Select, ToggleSwitch, FormsModule, Title, StateComponent],
    standalone:true,
